...
public class UserRegistrationAuthenticationController {
    ...
    public ResponseEntity<ReadUserDto> register(@RequestBody CreateUpdateUserDto createUpdateUserDto) {
    ...
    public ResponseEntity<ReadUserDto> authenticate(@RequestBody UserAuthDto userAuthDto) {
        return ResponseEntity.status(OK)
                .contentType(MediaType.APPLICATION_JSON)
                .body(userService.authenticate(userAuthDto.email(), userAuthDto.password()));
    }
}
